  ...
  return (
    <>
      <div className="container_gris">
        <h2 className="container_QuiSuisJe_title">Mes Services</h2>
        <div className="Service_container">
          ...
          <div className="Services">
            ...
            <ul >
              <li >
                Charte graphique personnaliser
              </li>
              ...
              <li >Optimisation du référencement (SEO)</li>
              <li >Mise en ligne du site</li>
              <li >Formation utilisation du site  <br /> Personalisé</li>
            </ul>
          </div>
          <div className="Services">
            <div className="Service">
            ...
            <h4>Développé Sur mesure  <br /> Version Premium <br />solution E-commerce</h4>
            <ul >
              <li >
                Charte graphique personnaliser
              </li>
        ...
        <h5 className="container_QuiSuisJe_title">*Conformément a l'aricle 296B du code général des impôts TVA non applicable </h5></div>
    </>
  );
};
