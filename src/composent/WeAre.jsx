        ...
        <div className="container_QuiSuisJe">
          ...
          <div className="container_photo">
            <p>
              ...
              ou à démarrer leur propre boutique en ligne.   <br />  <br />Que vous ayez besoin
              d'un site vitrine pour présenter votre activité, d'une boutique en
              ligne pour vendre vos produits, ou encore d'une application web
              personnalisée pour répondre à des besoins spécifiques, je suis là
